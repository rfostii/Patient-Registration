...
<form class="form-horizontal" role="form">
    ...
    <div class="form-group address">
        ...
        <div class="col-sm-8">
            <div class="help-block error"></div>
            <input type="text" name="address" class="form-control" placeholder="Address" value="{{if data.address}}{{>data.address}}{{/if}}">
        </div>
    </div>
    <div class="form-group city">
        ...
        <div class="col-sm-8">
            <div class="help-block error"></div>
            <input type="text" name="city" class="form-control" placeholder="City" value="{{if data.city}}{{>data.city}}{{/if}}">
        </div>
    </div>
    <div class="form-group state">
        ...
        <div class="col-sm-8">
            <div class="help-block error"></div>
            <input type="text" name="state" class="form-control" placeholder="State" value="{{if data.state}}{{>data.state}}{{/if}}">
        </div>
    </div>
    <div class="form-group zip">
        ...
        <div class="col-sm-8">
            <div class="help-block error"></div>
            <input type="text" name="zip" class="form-control" placeholder="Zip" value="{{if data.zip}}{{>data.zip}}{{/if}}">
        </div>
    </div>
    <div class="form-group phoneNumber">
        ...
        <div class="col-sm-8">
            <div class="help-block error"></div>
            <input type="text" name="phoneNumber" class="form-control" placeholder="Phone Number" value="{{if data.phoneNumber}}{{>data.phoneNumber}}{{/if}}">
        </div>
    </div>
    <div class="form-group employer">
        ...
        <div class="col-sm-8">
            <div class="help-block error"></div>
            <input type="hidden" name="employer" value="{{if data.employer}}{{>data.employer.id}}{{/if}}">
            ...
            <input type="text" class="form-control search-field" placeholder="Type Employer Name" value="{{if data.employer}}{{>data.employer.name}}{{/if}}">
