<form class="form-horizontal" role="form">
    ...
    <div class="form-group contact">
        ...
        <a href="#addEmployer" class="btn btn-default btn-link add-related"><span class="glyphicon glyphicon-plus"></span></a>
    </div>
    <div class="form-group employer">
        ...
        <a href="#addContact" class="btn btn-default btn-link add-related"><span class="glyphicon glyphicon-plus"></span></a>
    </div>
